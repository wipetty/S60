...
function generatePoemImage(poemText){
    if (debug_mode) {
        ...
        let formHTML = '<form class="form-inline" id="differentStyleSelector'+id+'" style="visibility: hidden;"><div class="form-group"><select class="form-control" id="model-type'+id+'"><option value="udnie">Udnie</option><option value="wave">Wave</option><option value="Duaiv">Italy Dream Lake</option><option value="la_muse">La Muse</option><option value="rain_princess">Rain Princess</option><option value="mathura">Mathura</option><option value="scream">Scream</option><option value="wreck">Wreck</option></select></div></form>'
